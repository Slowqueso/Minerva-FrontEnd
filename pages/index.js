...
export default function Home() {
  ...
  const COLORS = ["#cb59ff", "#79f1a4", "#c8f4fd"];
        ...
        <div className={`flex ${styles.introduction_container}`}>
          <div className={styles.introduction}>
            ...
            <p>
              ...
              Proof-of-Stake, the details of the Activity are registered in the
        ...
        <div className={`flex ${styles.introduction_container}`}>
          ...
          <div className={styles.introduction}>
            ...
            <p>
              ...
              the assigned task plays a very important role in ensuring security
              of the Activity. Smart contracts are self-executing contracts with
              the terms of the agreement between buyer and seller being directly
              written into lines of code. The code and the agreements contained
              therein are stored and replicated on a blockchain network.
            </p>
        ...
        <div className={`flex ${styles.introduction_container}`}>
          <div className={styles.introduction}>
            ...
            <p>
              ...
              will depend on the assumptions and inputs used in the valuation
              process.
            </p>
