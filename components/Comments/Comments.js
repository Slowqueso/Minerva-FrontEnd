  ...
  return (
    <div className={styles.comment_container}>
            ...
            return (
              <div className={styles.user_comment} key={comment._id}>
                <div className={styles.User}>
                    {
                      comment.profile_pic ? 
                        <img className={styles.profile_pic} src={comment.profile_pic} alt={comment.username} /> : 
                        <img className={styles.profile_pic} src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Windows_10_Default_Profile_Picture.svg/2048px-Windows_10_Default_Profile_Picture.svg.png" alt="default_profile" />
                    }
      ...
      <form className={styles.form} onSubmit={handleCommentSubmit}>
        ...
        ></textarea>
        <br />
          <p className={styles.character_count}>{newComment.length}/{200}</p>
        <br />
